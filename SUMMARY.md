...
* [介紹](content/en/intro/README.md)
   ...
   * [開箱設定](content/en/intro/getting_start.md)
   * [如何設定網路?](content/en/intro/setting_wifi.md)
   * [如何 ssh 進 LinkIt smart 7688](content/en/intro/ssh_7688.md)
   * [(非必要)如何 Reset LinkIt smart 7688](content/en/intro/reset_7688.md)
   * [(非必要)如何更新新的 firmware ?](content/en/intro/update_firmware.md)
* [基礎](content/en/basic/README.md)
   ...
   * [使用 cylon.js 來控制 LED](content/en/basic/cylon.md)
   * [如何自動一開機時啟動您的 Nodejs App ?](content/en/basic/linux_auto_start.md)
* [輕易結合雲端服務(MCS)](content/en/cloud/README.md)
   * [使用 MCSjs 讓 MCS 來操控 linkit smart 7688](content/en/cloud/MCSjs.md)
   * [使用 MCS + firmata 控制 LED](content/en/cloud/mcs_firmata.md)
   * [使用 LinkIt smart 7688 Duo 搭配 MCS gamepad channel 製作遙控戰車](content/en/cloud/gamepad.md)
* [Web of things](content/en/wot/README.md)
* [經典範例](content/en/example/README.md)
   * [使用 touch sensor 觸發 LED](content/en/example/touch_sensor.md)
